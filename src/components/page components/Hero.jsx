        ...
        <div className="container">
          <div className="grid grid-cols-1 2xl:-mx-4">
            <div className="xl:pt-12">
              ...
              <h2
                className="font-Syne text-black-800 font-bold text-[80px] lg:text-[80px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px]"
                data-aos="fade-right"
                data-aos-delay={600}
              >
                Kumar
              ...
              >
                <div className="flex flex-wrap items-center">
                  <span
                    ref={countUpRef}
                    className="font-Syne text-black-800 font-bold text-[44px] leading-none"
                  >
                    {isVisible && (
                      <CountUp
                        start={1}
