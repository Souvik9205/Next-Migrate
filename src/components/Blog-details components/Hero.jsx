      ...
      <>
          ...
          >
            <div className="grid grid-cols-1">
              ...
              <img
                ...
                src="assets/images/blog-details/banner2.png"
                alt="banner"
              />
            </div>
          </div>
        ...
        <section className="bg-white pb-[120px] mt-[-280px] pt-[280px]">
          <div className="max-w-[1075px] mx-auto px-4 xl:px-0">
            <div className="grid grid-cols-1 mb-12">
              <ul className="flex flex-wrap gap-x-[80px] gap-y-6 pb-8 border-b border-black-800 border-opacity-10">
                <li className="flex flex-wrap gap-3">
                  <img
                    src="assets/images/blog-details/user.png"
                    alt="user image"
                  />
            ...
            <div className="grid grid-cols-1">
              <h3 className="text-2xl font-bold font-Syne leading-10 mb-5">
                About the position
              </h3>
            ...
            <div className="grid grid-cols-12 gap-4 md:gap-6 mb-12">
              <div className="col-span-6">
                <img
                  ...
                  src="assets/images/blog-details/post3.png"
                  alt="post image"
                />
              </div>
              <div className="col-span-6">
                <img
                  className="w-full h-full rounded-[20px]"
                  src="assets/images/blog-details/post4.png"
                  alt="post image"
                />
              </div>
            </div>
            <div className="grid grid-cols-1 gap-6">
              <h3 className="text-2xl font-bold font-Syne leading-10">
                      ...
                      >
                        ...
                        >
                          ...
                          <path
                            ...
                            fill="currentColor"
                            fillOpacity="0.9"
                            mask="url(#path-1-inside-1_1554_1179)"
                          />
                        </svg>
                      </a>
                    </li>
